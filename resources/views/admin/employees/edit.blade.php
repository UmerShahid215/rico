        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            <div class="kt-portlet kt-portlet--tabs">
                ...
                <div class="kt-portlet__body">
                    <form action="{{route('admin.employees.update',$user->id)}}" method="post" enctype="multipart/form-data" id="my-form">
                        @csrf
                        @method('put')
                                            ...
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="input-group">
                                                            <div class="input-group-prepend"><span class="input-group-text"><i class="la la-phone"></i></span></div>
                                                            <input type="number" class="form-control" placeholder="3520223453451"  aria-describedby="basic-addon1" name="cninc" value="{{ $user->cninc}}">
                                                        </div>
                                                        @error('cninc')
                                                        <span class="kt-font-danger">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="date" class="form-control" placeholder="DOB"  aria-describedby="basic-addon1" name="dob" value="{{
                                                            $user->dob}}">
                                                        </div>
                                                        @error('dob')
                                                        <span class="kt-font-danger">{{ $message }}</span>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Select Supevisor Admin</label>
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="input-group">
                                                            <div class="input-group-prepend"><span class="input-group-text"><i class="la la-user"></i></span></div>
                                                            <select  class="form-control"   aria-describedby="basic-addon1" name="parent_id" >
                                                                @forelse($users as $user)
                                                                <option value="{{ $user->id }}" {{ $user->parent_id === $user->id ? 'selected' : '' }}>{{ $user->full_name . '(' .$user->email .')' }}</option>
