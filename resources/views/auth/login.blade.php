...
{{--                            <img src="{{asset('assets/media/logos/logo-mini-2-md.png')}}">--}}
                    ...
                    <div class="kt-login__signin">
                        <div class="kt-login__head">
                            <h3 class="kt-login__title">Sign In To RICO</h3>
                        </div>
...
<!--begin:: Vendor Plugins -->
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/jquery/dist/jquery.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/popper.js/dist/umd/popper.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/bootstrap/dist/js/bootstrap.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/js-cookie/src/js.cookie.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/moment/min/moment.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/tooltip.js/dist/umd/tooltip.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/perfect-scrollbar/dist/perfect-scrollbar.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/sticky-js/dist/sticky.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/wnumb/wNumb.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/jquery-form/dist/jquery.form.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/block-ui/jquery.blockUI.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/js/global/integration/plugins/bootstrap-datepicker.init.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/bootstrap-datetime-picker/js/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/bootstrap-timepicker/js/bootstrap-timepicker.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/js/global/integration/plugins/bootstrap-timepicker.init.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/bootstrap-daterangepicker/daterangepicker.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/bootstrap-maxlength/src/bootstrap-maxlength.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/plugins/bootstrap-multiselectsplitter/bootstrap-multiselectsplitter.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/bootstrap-select/dist/js/bootstrap-select.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/bootstrap-switch/dist/js/bootstrap-switch.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/js/global/integration/plugins/bootstrap-switch.init.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/select2/dist/js/select2.full.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/ion-rangeslider/js/ion.rangeSlider.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/typeahead.js/dist/typeahead.bundle.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/handlebars/dist/handlebars.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/inputmask/dist/jquery.inputmask.bundle.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/inputmask/dist/inputmask/inputmask.date.extensions.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/inputmask/dist/inputmask/inputmask.numeric.extensions.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/nouislider/distribute/nouislider.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/owl.carousel/dist/owl.carousel.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/autosize/dist/autosize.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/clipboard/dist/clipboard.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/dropzone/dist/dropzone.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/js/global/integration/plugins/dropzone.init.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/quill/dist/quill.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/@yaireo/tagify/dist/tagify.polyfills.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/@yaireo/tagify/dist/tagify.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/summernote/dist/summernote.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/markdown/lib/markdown.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/bootstrap-markdown/js/bootstrap-markdown.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/js/global/integration/plugins/bootstrap-markdown.init.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/bootstrap-notify/bootstrap-notify.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/js/global/integration/plugins/bootstrap-notify.init.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/jquery-validation/dist/jquery.validate.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/jquery-validation/dist/additional-methods.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/js/global/integration/plugins/jquery-validation.init.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/toastr/build/toastr.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/dual-listbox/dist/dual-listbox.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/raphael/raphael.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/morris.js/morris.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/chart.js/dist/Chart.bundle.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/plugins/bootstrap-session-timeout/dist/bootstrap-session-timeout.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/plugins/jquery-idletimer/idle-timer.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/waypoints/lib/jquery.waypoints.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/counterup/jquery.counterup.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/es6-promise-polyfill/promise.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/sweetalert2/dist/sweetalert2.min.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/js/global/integration/plugins/sweetalert2.init.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/jquery.repeater/src/lib.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/jquery.repeater/src/jquery.input.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/jquery.repeater/src/repeater.js" type="text/javascript"></script>
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/plugins/general/dompurify/dist/purify.js" type="text/javascript"></script>

<!--end:: Vendor Plugins -->
<script src="{{asset('assets/media/logos/logo-mini-2-md.png')}}assets/js/scripts.bundle.js" type="text/javascript"></script>
