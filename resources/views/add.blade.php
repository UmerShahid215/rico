        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            <div class="kt-portlet kt-portlet--tabs">
                ...
                <div class="kt-portlet__body">
                    <form action="{{url('user/add/')}}" method="post" enctype="multipart/form-data" id="my-form">
                        @csrf
                        <?php

//                        $role = DB::table('roles')->where('id' , DB::table('model_has_roles')->where('model_id' , auth()->user()->id)->pluck('role_id')->first())
//                                                            ->pluck('name')->first();
                                    ?>
...
{{--																			</span>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="input-group">
                                                            <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-address-card" aria-hidden="true"></i></span></div>
                                                            <input type="text" class="form-control" placeholder="CNIC"  aria-describedby="basic-addon1" name="cnic">
                                                        </div>
                                                        {{--                                                    <span class="form-text text-muted">We'll never share your email with anyone else.</span>--}}
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="date" class="form-control" placeholder="DOB"  aria-describedby="basic-addon1" name="dob">
                                                        </div>
                                                        {{--                                                    <span class="form-text text-muted">We'll never share your email with anyone else.</span>--}}
                                                    </div>
                                                </div>
